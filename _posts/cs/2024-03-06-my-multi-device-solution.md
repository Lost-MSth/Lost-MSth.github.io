---
modify_date: "2026-04-11 23:00:00"
title: 个人多设备使用解决方案
...
相关设置非常简单，在“编辑”的“首选项”中的“同步”页面，在“文件同步”中选择同步方式为“WebDAV”，输入服务器地址和端口，如果没有设置 SSL 前面协议选择 http，用户名和密码就是刚才设置好的，之后点击“验证服务器”就可以判断是否成功设置了，底下我设置了“下载文件在需要时”，并关闭官方的 Zotero 云存储功能
...
> AutoBangumi 的新版本非常难用，看了下仓库，源码直接通过 Release 发布但是里面又没有依赖文件，下下来基本上没法跑起来的，而且就算能跑，在日常的使用中好像莫名奇妙就会把下载器干崩了。算了，找了个替代品 ANI-RSS（实际上感觉是上位替代），使用方法差不多，但不使用聚合订阅，就是把在 Mikan 上登录后订阅改成了单独订阅，直接把订阅链接丢到 ANI-RSS 中就好了。不过我有点担心 RSS 订阅过多会不会有问题，可能需要我手动取消过时的订阅了，或者使用什么摸鱼检测。
